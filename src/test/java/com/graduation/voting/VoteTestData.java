...
public class VoteTestData {
    ...
    public static final Vote VOTE1_ADMIN_RESTAURANT1 = new Vote(VOTE1_ID, of(2020,04,01), ADMIN, RESTAURANT2);
...
//    public static final List<Vote> USER1_VOTES = List.of(VOTE2_USER1_RESTAURANT2,VOTE5_USER1_RESTAURANT2);
    public static final List<Vote> RESTAURANT2_VOTES = List.of(VOTE5_USER1_RESTAURANT2, VOTE4_ADMIN_RESTAURANT2, VOTE1_ADMIN_RESTAURANT1);
